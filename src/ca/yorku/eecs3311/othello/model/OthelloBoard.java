...
//	
	...
	public boolean move(int row, int col, char player) {
		...
		return modifyBoard(row, col, player, player);
	}
	 ...
	 * @author vinceflores
	 */
	private boolean modifyBoard(int row, int col,char curr, char player) {
		int numChangedTotal = flip(row, col, player);
	 ...
	 * @author vinceflores
	 */
	private int flip(int row, int col, char player) {
